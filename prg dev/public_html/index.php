...
<body lang="ja">
	...
	<center>
		<p>
			<FONT color="#FF0000"><strong>ログイン成功してから【30分】経過するとタイムアウトします</strong></FONT>
		</p>
	</center>
	...
	<form method="post">
		<fieldset name="Group1">
			...
			<p>
				<strong>☆重要☆　設計開発２で公開したIDはなんとか削除しました</strong>
			</p>
		</fieldset>
		<hr>
	</form>
		...
		if(!empty($name)&& !empty($Password)){
			...
			if($Password == $db_hashed_pwd){
				...
				if($name==$Password){
					...
					$lifetime = 30 * 60;//30分のタイムアウトを設定しておけばおｋ？
