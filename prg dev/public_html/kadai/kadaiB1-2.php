...
次の(1)から(3)の機能を有する文字列をコピーするプログラムを作成しなさい。以下のURLを参考にすること。
</span></strong></p>
<p class="auto-style15"><br />
(1) "文字列を入力してください＞"と表示する。<br/>
(2) scanf()を使い、文字列をキーボードから読み込み、char型の配列s[]に格納する。<br/>
(3) 文字列s[]中の文字列のコピーを別のchar型の配列d[]に作成する。ただし、コピーにはfor文を使用し、1文字ずつd[]に書き込むこと。<br/>
(4) 文字列のコピー後、s[]とd[]の両方の文字列を表示する。<br/>
<br/>
