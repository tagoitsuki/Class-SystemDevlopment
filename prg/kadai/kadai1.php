...
<body>
	...
	<form method="post">
		<div class="auto-style22" id="layer2">
			<button name="read" formaction="readfile.php">一時保存してあったファイルを読み込む</button>
		</div>
...
int	main( void )
{
	...
	return 0;
		...
		<div class="auto-style22" id="layer1">
			<button class="auto-style2" name="save" formaction="savefile.php">一時保存</button>
			<button class="auto-style2" name="faq" formaction="http://10.8.68.230/~tto/faq.html">質問</button>　
			<button class="auto-style2" name="runstart" formaction="http://10.8.68.230/~tto/compile_execute_result.html">コンパイル・実行</button>　
