					...
					<p class="auto-style15">
						<strong>
							<span class="auto-style14">
								二次方程式の係数a,b,cをキー入力し、解を求めるプログラムを作成しなさい。
							</span>
						</strong>
					</p>
					<p class="auto-style15">
						＜出力メッセージ（9は仮の数字）＞<br />
							aが0&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;"二次方程式ではありません\n"<br />
							判別式がマイナス　"虚数解です\n"<br />
							重解&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;"重解です x=999.99\n"<br />
							2つの解&emsp;&emsp;&emsp;&emsp;"x1=999.99\n",;"x2=999.99\n"
					</p>
					<p class="auto-style15">
							＜テスト＞　以下の値のときの解を計算して実行結果と比較すること<br />
