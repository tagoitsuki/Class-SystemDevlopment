...
次の(1)～(4)の機能を有するプログラムを作成せよ。また、下記URLを参考にすること。
</span></strong></p>
<p class="auto-style15"><br />
(1) ”文字列を入力してください＞”と表示する。<br/>
(2) scanf()を使い、文字列をキーボードから読み込み、char型の配列s[]に格納する。<br/>
(3) s[]の先頭の文字を5個並べた文字列をchar型の配列d[]に生成する。ただし、生成にはfor文を使用し、1文字ずつd[]に書き込むこと。<br/>
(4) 文字列の生成後、s[]とd[] の両方の文字列を表示する。<br/><br/>
URL: https://doc.co/3phMAY
