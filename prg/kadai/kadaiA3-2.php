...
次の(1)から(4)の機能を有するプログラムを作成せよ。なお、以下のURLを参考に作成すること。
</span></strong></p>
<p class="auto-style15"><br />
(1) rand(), time(), srand()を使い0以上999以下の値を生成し、それを整数型の配列data[]に格納する。<br/>
(2) 配列data[]の初期値を10個ごとに改行し表示する。<br/>
(3) 選択ソートにより配列data[]の要素の値を降順に並べ替える。<br/>
(4) 並べ替え後、(2)と同様に配列data[]の値を10個ごとに改行し表示する。<br/>
</p>
