					...
					<p class="auto-style15">
						<strong>
							<span class="auto-style14">
								【if, else if 版】閏年判定を行うプログラムを作成しなさい。ただし、if, else if, elseを使うこと。
							</span>
						</strong>
					</p>
					<p class="auto-style15">
						<br />
						西暦を入力し閏年かどうかを判定し、閏年なら○を、そうでなければ×を表示する。<br />
						閏年：西暦で、4で割り切れて100で割切れない、または400で割切れる年（2月は29日まで）<br />
						★3つの条件を別々の if, else if文 で作成すること<br />
					</p>
				</div>
			</fieldset>
		</div>
