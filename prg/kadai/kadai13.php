					...
					<p class="auto-style15">
						<strong>
							<span class="auto-style14">
								for文を使って、配列の中の最大値を求め、要素番号と値を表示するプログラムを作成しなさい。
							</span>
						</strong>
					</p>
					<p class="auto-style15">
						<br />
						&emsp;&emsp;以下の条件でテストし正しく動作するのを確認すること<br />
						&emsp;&emsp;① 最大値が最初にある場合<br />
						&emsp;&emsp;② 最大値が最後にある場合<br />
						&emsp;&emsp;③ すべての値がマイナスの値の場合<br />
					</p>
				</div>
			</fieldset>
		</div>
